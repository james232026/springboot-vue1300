...
public class ShitixinxiController {
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ShitixinxiEntity shitixinxi, 
		HttpServletRequest request){
        EntityWrapper<ShitixinxiEntity> ew = new EntityWrapper<ShitixinxiEntity>();
		PageUtils page = shitixinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, shitixinxi), params), params));
        return R.ok().put("data", page);
    ...
    public R info(@PathVariable("id") Long id){
		...
		shitixinxi.setClicktime(new Date());
		shitixinxiService.updateById(shitixinxi);
    ...
    public R autoSort(@RequestParam Map<String, Object> params,ShitixinxiEntity shitixinxi, HttpServletRequest request,String pre){
        EntityWrapper<ShitixinxiEntity> ew = new EntityWrapper<ShitixinxiEntity>();
