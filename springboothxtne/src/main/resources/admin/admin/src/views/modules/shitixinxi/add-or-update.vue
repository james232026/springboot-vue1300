<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="题目编号" prop="timubianhao">
          <el-input v-model="ruleForm.timubianhao" 
              placeholder="题目编号" clearable  :readonly="ro.timubianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="题目编号" prop="timubianhao">
              <el-input v-model="ruleForm.timubianhao" 
                placeholder="题目编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="选项" prop="xuanxiang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="选项"
                  v-model="ruleForm.xuanxiang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xuanxiang" label="选项" prop="xuanxiang">
                    <span>{{ruleForm.xuanxiang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kemuleixing = true;
          ...
          if(o=='timubianhao'){
            this.ruleForm.timubianhao = obj[o];
	    this.ro.timubianhao = true;
            continue;
          }
          if(o=='timu'){
